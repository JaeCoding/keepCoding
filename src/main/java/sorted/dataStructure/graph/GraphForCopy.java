...
public class GraphForCopy {
    ...
    public class Graph {
        ...
        public void DfsPaths(sorted.dataStructure.graph.Graph G, int s) {
        ...
        private void dfs(sorted.dataStructure.graph.Graph G, int v) {
         ...
         */
        public void bfs(sorted.dataStructure.graph.Graph G, int s) {
