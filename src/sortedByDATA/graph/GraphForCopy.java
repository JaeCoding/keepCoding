...
public class GraphForCopy {
    ...
    public class Graph {
        ...
        public void DfsPaths(sortedByDATA.graph.Graph G, int s) {
        ...
        private void dfs(sortedByDATA.graph.Graph G, int v) {
         ...
         */
        public void bfs(sortedByDATA.graph.Graph G, int s) {
