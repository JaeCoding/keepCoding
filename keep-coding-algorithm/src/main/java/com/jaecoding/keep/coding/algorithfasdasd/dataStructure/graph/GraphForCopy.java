...
public class GraphForCopy {
    ...
    public class Graph {
        ...
        public void DfsPaths(com.jaecoding.keep.coding.algorithfasdasd.dataStructure.graph.Graph G, int s) {
        ...
        private void dfs(com.jaecoding.keep.coding.algorithfasdasd.dataStructure.graph.Graph G, int v) {
         ...
         */
        public void bfs(com.jaecoding.keep.coding.algorithfasdasd.dataStructure.graph.Graph G, int s) {
