package com.jaecoding.keep.coding.config;

/**
 * OrderStateMachineConfig2
 *
 * @author pengwenjie3
 * @date 2020/7/9
 * @since 1.8
...
public class OrderStateMachineConfig2 extends EnumStateMachineConfigurerAdapter<OrderStatus, OrderStatusChangeEvent> {
